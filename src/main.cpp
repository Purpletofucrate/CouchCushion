...
uint256 hashGenesisBlock("0x4fe8429e5971e500b6f73ac0d09d6c042a8b049e30ef29a67bc91ea0c4fa11b7");
...
const string strMessageMagic = "CouchCushion Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CouchCushion: 1 days
static const int64 nTargetSpacing = 120; // CouchCushion: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal couchcushion miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CouchCushion", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb350af30e46dd846d330ec853896ad33377388e030a219c5ce7dac9e17ac060b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Trump, Defending His Mental Fitness, Says He’s a ‘Very Stable Genius’";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1517266325; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 731488;

        if (fTestNet)
        {
            block.nTime    = 1515333521;
            block.nNonce   = 731488;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8a62477ebf7c64aea9a656487a0474c335b256f38c2e5958504cb9b8cd9c91b7"));
