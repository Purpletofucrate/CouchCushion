...
static const char *strDNSSeed[][2] = {
    {"CouchCushion Github", "https://github.com/Purpletofucrate/CouchCushion"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CouchCushion is probably already running."), addrBind.ToString().c_str());
        else
